...
export default function HomeScreen() {
  ...
  const [allFood, setAllFood] = useState([
    ...
    },
    {
      ...
      recipeCategory: "Beef",
      recipeOrigin: "French",
      cookingDescription: "Preheat the oven to 150°C. Heat oil in a large casserole, brown the beef, and set aside.",
    ...
    },
    {
      ...
      cookingDescription: "Heat butter in a pan, cook the beef strips until browned.",
    ...
    },
    {
      ...
      idCategory: "1",
      category: 'Beef',
      recipeInstructions: "To make Beef Tacos, heat 1 tablespoon of oil in a skillet over medium heat, then add 500g of ground beef and cook until browned, breaking it up with a spoon. Drain excess fat and stir in 1 packet of taco seasoning along with 1/4 cup of water. Simmer for 5-7 minutes until the beef is fully cooked. Warm taco shells or tortillas, then fill them with the seasoned beef. Top with shredded lettuce, diced tomatoes, grated cheese, sour cream, salsa, and guacamole.",
      ...
      cookingDescription: "In a skillet, cook the beef until browned. Add onions, garlic, cumin, and chili powder.",
    ...
    },
    {
      ...
      idFood: '13',
      category: 'Chicken',
      recipeInstructions: "To make Buffalo Chicken Wings, preheat your oven to 200°C (400°F). Toss 1 kg of chicken wings with salt, pepper, and 1 teaspoon of baking powder, then arrange them in a single layer on a wire rack. Bake for about 40-45 minutes, turning halfway, until golden and crispy. Meanwhile, in a saucepan, melt 1/2 cup of unsalted butter and whisk in 1/2 cup of hot sauce and 1 tablespoon of vinegar. Once the wings are done, toss them in the Buffalo sauce until well coated.",
